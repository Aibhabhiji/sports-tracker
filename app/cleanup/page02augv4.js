...
const SPORTS_LIST = [
  { id: 'cricket', name: 'Cricket', type: 'CRICKET_CUSTOM' },
...
export default function SanviOlympicsPortal() {
  const [activeSport, setActiveSport] = useState(SPORTS_LIST[0]); // Default to Cricket for testing
  ...
  // Robust participant filtering supporting both gameChoice/sport and ageGroup/age properties
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 font-sans space-y-6">
      ...
      {/* 2. 3-COLUMN SPONSOR BANNER (Matching Top Band Width) */}
      ...
      {activeSubTab === 'scores' && (
        <div>
          {activeSport.type === 'CRICKET_CUSTOM' && (
